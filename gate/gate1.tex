...
\begin{align}
a_k=\frac{1}{N}\sum\limits_{n=0}^{N-1} x(n)e^{\frac{-j2\pi kn}{N}}
\end{align}
Given that time period of x(n) is N=5 sec.\\
\begin{align}
a_k&=\frac{1}{5}\sum\limits_{n=0}^{4} x(n)e^{\frac{-j2\pi kn}{5}}\\
\sum\limits_{n=0}^{4} x(n)e^{\frac{-j2\pi kn}{5}}&=5a_k\label{eq:gate23ec47eq5}
\end{align}
Referencing from equation\eqref{eq:gate23ec47eq5}, equation\eqref{eq:gate23ec47eq2} can be written as:
\begin{align}
\sum\limits_{n=0}^{4}x(n) \sin\brak{\frac{4\pi n}{5}}&=\frac{1}{2j}\sbrak{5a_{-2}-5a_2}\label{eq:gate23ec47eq6}
\end{align}
...
\begin{align}
\sum\limits_{n=0}^{4}x(n) \sin\brak{\frac{4\pi n}{5}}&=\frac{1}{2j}\sbrak{5a_3-5a_2}\\
...
&=\frac{1}{2j}\sbrak{\sum\limits_{n=0}^{7}x[n]e^{\frac{j2\pi (2)n}{8}}-\sum\limits_{n=0}^{7}x[n]e^{\frac{-j2\pi (2)n}{8}}}\label{eq:gate23ec47eq11}
\end{align}
DTFS coefficient is given by,\\
\begin{align}
a_k=\frac{1}{N}\sum\limits_{n=0}^{N-1} x(n)e^{\frac{-j2\pi kn}{N}}
...
\begin{align}
a_k&=\frac{1}{8}\sum\limits_{n=0}^{7} x(n)e^{\frac{-j2\pi kn}{8}}\\
\sum\limits_{n=0}^{7} x(n)e^{\frac{-j2\pi kn}{8}}&=8a_k\label{eq:gate23ec47eq14}
\end{align}
Referencing from equation\eqref{eq:gate23ec47eq14}, equation\eqref{eq:gate23ec47eq11} can be written as:
\begin{align}
\sum\limits_{n=0}^{7}x(n) \sin\brak{\frac{4\pi n}{8}}&=\frac{1}{2j}\sbrak{8a_{-2}-8a_2}\label{eq:gate23ec47eq15}
\end{align}
From the property of discrete Fourier series.\\
\begin{align}
a_k=a_{k+N}
\end{align}
So, equation\eqref{eq:gate23ec47eq15} becomes,\\
\begin{align}
\sum\limits_{n=0}^{7}x(n) \sin\brak{\frac{4\pi n}{8}}&=\frac{1}{2j}\sbrak{8a_6-8a_2}\\
